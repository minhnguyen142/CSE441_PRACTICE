package com.hikari.ex18.adapter;
...
import com.hikari.ex18.MainActivity;
import com.hikari.ex18.R;
import com.hikari.ex18.ResultActivity;
...
public class SongAdapter extends ArrayAdapter<Song> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.imgFavorite = convertView.findViewById(R.id.btnLike);
